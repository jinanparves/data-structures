...
public class PriorityQueueDemo
{
    public static void main(String[] args)
    {
        ...
        Queue<WorkOrder> toDo = new PriorityQueue<WorkOrder>();
        ...
        while (toDo.size() > 0){
            System.out.println(toDo.remove()); // In other words, priorityOrder only comes into play when you are removing it from the queue. NOT when you are adding to the queue. 
        }
    }
}
